...
.Python data structures
   ...
   .Tuples
   .Dictionaries
.Basic Program Set On Data Structures
...
.LISTS
      ...
      .Its one of the command data structure supports by python ,the list items are seperated by comma
        operator and enclosed in square brackets.
        .example
          .list1=[1,6,2,18,9]
...
-this algorithm compares the adj elements,if the first
element is greater
-than second element then its required to swap the
# In[69]:
